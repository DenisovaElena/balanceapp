...
import static ru.example.balanceapp.controller.AbstractControllerTest.RequestWrapper.wrap;
...
abstract public class AbstractControllerTest {
    ...
    public static class RequestWrapper {
        ...
        public RequestWrapper basicAuth(User user) {
            builder.with(SecurityMockMvcRequestPostProcessors.httpBasic(user.getLogin(), user.getPassword()));
            return this;
        }

        public RequestWrapper auth(User user) {
            builder.with(SecurityMockMvcRequestPostProcessors.authentication(new UsernamePasswordAuthenticationToken(user.getLogin(), user.getPassword())));
            return this;
        }
    }
